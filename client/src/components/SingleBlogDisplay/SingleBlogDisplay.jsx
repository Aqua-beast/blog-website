...
function SingleBlogDisplay() {
  ...
  useEffect(() => {
    axios
      .get(`https://blog-website-4zc7.vercel.app//articles/${slug}`, {
        headers: {
  ...
  const handleLike = () => {
    axios
      .post(`https://blog-website-4zc7.vercel.app//articles/${slug}/like`, {}, {
        headers: {
          'x-access-token': localStorage.getItem('token'),
        },
      })
  ...
  const handleComment = () => {
    axios
      .post(`https://blog-website-4zc7.vercel.app//articles/${slug}/comment`, {username: JSON.parse(localStorage.getItem("userdata")).username ,comment: newComment }, {
        headers: {
          'x-access-token': localStorage.getItem('token'),
        },
      })
